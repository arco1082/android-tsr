...
package com.clickherelabs.texasscottishrite.widget;
...
public class TextResizeTransition extends Transition {
    ...
    private static final String PROPERTY_NAME_TEXT_RESIZE =
            "com.clickherelabs.texasscottishrite.widget:TextResizeTransition:textSize";
    private static final String PROPERTY_NAME_PADDING_RESIZE =
            "com.clickherelabs.texasscottishrite.widget:TextResizeTransition:paddingStart";
