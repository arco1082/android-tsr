...
import com.clickherelabs.texasscottishrite.helper.ParcelableHelper;
...
public class Category implements Parcelable {
    ...
    public Category(String name, String id, Theme theme, List<Quiz> quizzes, boolean solved, String action) {
        mName = name;
        mId = id;
        mTheme = theme;
        mQuizzes = quizzes;
    ...
    public Category(String name, String id, Theme theme, List<Quiz> quizzes,
                    int[] scores, boolean solved, String action) {
        mName = name;
        mId = id;
        mTheme = theme;
