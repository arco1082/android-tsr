package com.clickherelabs.texasscottishrite.carboard;
...
/**
 * Created by armando_contreras on 7/22/16.
 */
public class CardBoardActivity extends GvrActivity implements GvrView.StereoRenderer {
    ...
    public static Intent getStartIntent(Context context, Category category) {
        Intent starter = new Intent(context, CardBoardActivity.class);
    ...
    public void initializeGvrView() {
        setContentView(R.layout.carboard_view);
